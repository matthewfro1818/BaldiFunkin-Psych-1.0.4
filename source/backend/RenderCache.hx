...
class RenderCache extends FlxBasic
{
	...
	public function push(obj:OneOfTwo<FlxSprite, FlxGraphic>)
	{
		...
		// optional tracking of graphics; removed because the Psych fork doesn't
		// include a FunkinAssets cache implementation.
		// if (graphic.key != null)
		// {
		//     if (!FunkinAssets.cache.currentTrackedGraphics.exists(graphic.key)) 
		//         FunkinAssets.cache.currentTrackedGraphics.set(graphic.key, graphic);
		// }
